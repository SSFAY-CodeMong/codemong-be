...
public class AIService {
    ...
    public CodeReviewResponse codeReview(Long repositoryId, Long step, Long userId) {
        ...
        String systemPrompt = """
                ...
                코드, 명령어, 설정 파일, 에러 로그, diff, JSON, XML, HTML은 반드시 fenced code block으로 감싼다.
                가능하면 언어명을 함께 표기한다.
                여러줄의 코드인 경우 ```으로 감싼다.
                응답 결과가 너무 길어지지 않도록 간결하게 전달한다.
                특히 개선 제안은 사용자가 생각하고 학습할 수 있도록 간단한 방향만 제시한다.
                ...
                1번 전체요약 이전과 5번 최종 점수와 총평 이후에 내용을 작성하지 않는다.
            """;
