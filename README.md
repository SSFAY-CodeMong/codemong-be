...
| 최현철 | Backend / Auth / User Flow / AI        | GitHub OAuth 로그인 및 최초 회원가입 흐름, 사용자 화면 구현, 프로젝트 선택/Step 선택 UI, 검사 결과 및 피드백 화면, 리포트 화면, 전체 사용자 경험 개선                 |
...
* 백엔드 개발자 뿐만 아니라 프론트, AI 개발자를 위한 트랙 추가
